...
def main():
	#Sentence_Similarity.get_data_for_plotting()

	# x,y,_,_,_,_ = Sentence_Similarity.load_data_for_plotting()
	...
	# 	plt.colorbar()
	# 	if y[i] == 1:
	# 		plt.savefig('results/images/ActualPositive/'+str(i))
	# 	else:
	# 		plt.savefig('results/images/ActualNegative/'+str(i))
